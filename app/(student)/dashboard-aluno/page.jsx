      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-2xl border border-bjj-gray-800 bg-bjj-gray-900/70 p-5">
          <header className="mb-3 flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-bjj-gray-400">Progresso</p>
              <h3 className="text-lg font-semibold">Rumo ao próximo grau</h3>
            </div>
            <Medal size={18} className="text-bjj-red" />
          </header>
          <div className="space-y-2">
            <div className="flex justify-between text-sm text-bjj-gray-200/80">
              <span>Aulas concluídas no grau atual</span>
              <span>
                {progressoProximoGrau.aulasNoGrau}/{progressoProximoGrau.alvo}
              </span>
            </div>
            ...
            <p className="text-xs text-bjj-gray-300/80">Meta estimada: {progressoProximoGrau.alvo} aulas</p>
          </div>
        </div>
