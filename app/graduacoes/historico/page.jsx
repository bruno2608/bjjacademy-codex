...
function GraduacoesHistoricoPageContent() {
  ...
  return (
    <div className="space-y-8">
      <header className="card space-y-3">
        ...
        <h1 className="text-2xl font-semibold text-bjj-white">Histórico de graduações</h1>
        <p className="max-w-3xl text-sm text-bjj-gray-200/70">
          Consulte promoções concluídas e registros oficiais de graduação. Os dados são mockados e servem como referência para
          a visão staff.
        </p>
        {staff?.nome && (
      ...
      <section className="card space-y-4">
        <div className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.18em] text-bjj-gray-200/70">
          <ShieldCheck size={14} /> Histórico recente
        </div>
        <GraduacoesHistoricoView historico={historico} periodoFiltro={periodoFiltro} />
      </section>
    </div>
  )
}
...
export default function GraduacoesHistoricoPage() {
  return <GraduacoesHistoricoPageContent />
}
