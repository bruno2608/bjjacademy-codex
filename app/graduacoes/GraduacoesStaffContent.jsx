...
export default function GraduacoesStaffPageContent({ defaultView = 'proximas', showTabs = true }) {
  ...
  const activeView = useMemo(() => {
    ...
    return allowed.includes(fromQuery) ? fromQuery : defaultView;
  ...
  const handleViewChange = (nextView) => {
    ...
    window.history.replaceState({}, '', `/graduacoes?${params.toString()}`);
  };
