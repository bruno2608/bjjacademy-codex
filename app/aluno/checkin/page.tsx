...
import { ArrowRight, Clock3, HandRaised, History } from 'lucide-react'
    ...
    <div className="space-y-6">
              ...
              {recentes.map((presenca) => (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-bjj-gray-300">Origem: {presenca.origem === 'ALUNO' ? 'Manual' : presenca.origem === 'PROFESSOR' ? 'Professor' : 'Sistema'}</p>
                  </div>
                  <span
      ...
      <div className="mx-auto max-w-3xl rounded-2xl border border-dashed border-bjj-gray-800 bg-bjj-gray-900/40 px-5 py-4 text-bjj-gray-100">
        ...
        <p className="text-sm text-bjj-gray-200">
          Abra o card de Check-in Manual e confirme sua presença. Ela aparecerá automaticamente na lista de recentes.
        </p>
      </div>
    </div>
  )
