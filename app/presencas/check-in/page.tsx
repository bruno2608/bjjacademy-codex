...
export default function PresencasCheckInPage() {
      ...
      <div className="rounded-2xl bg-bjj-gray-900/80 p-4 ring-1 ring-bjj-gray-800">
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-bjj-gray-800 bg-bjj-gray-950/70 p-5 text-bjj-gray-50">
          <div className="mb-3 flex items-center gap-2 text-white">
            ...
            <p className="text-lg font-semibold">QR Code Check-in</p>
          </div>
          <p className="text-sm text-bjj-gray-200">Acesse as telas de QR Code para validar presenças simuladas.</p>
