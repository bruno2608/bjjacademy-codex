...
| Área do Aluno | Layout separado com dashboard próprio, check-in, treinos do aluno, evolução e perfil editável (nome/contato/foto) via `/perfil`; históricos, documentos e relatórios pessoais acessíveis pelo menu do usuário. |
...
- **Aluno:** acessa o layout `(student)` com dashboard próprio, check-in, treinos do aluno, evolução e perfil editável (nome/contato/foto) via `/perfil`. Tentativas de visitar rotas administrativas redirecionam para `/dashboard-aluno`; históricos, documentos e relatórios pessoais ficam no menu do usuário.
