...
const STAFF_DRAWER = [
  ...
  { title: 'Presenças – Chamada do dia', path: '/presencas', href: { pathname: '/presencas', query: { view: 'chamada' } } },
  {
    title: 'Presenças – Pendências de aprovação',
    path: '/presencas',
    href: { pathname: '/presencas', query: { view: 'pendencias' } }
  },
  {
    title: 'Presenças – Revisão / últimos envios',
    path: '/presencas',
    href: { pathname: '/presencas', query: { view: 'revisao' } }
  },
  { title: 'Alunos', path: '/alunos' },
  { title: 'Graduações – Próximas graduações', path: '/graduacoes', href: { pathname: '/graduacoes', query: { view: 'proximas' } } },
  { title: 'Graduações – Histórico recente', path: '/graduacoes', href: { pathname: '/graduacoes', query: { view: 'historico' } } },
  { title: 'Relatórios', path: '/relatorios' },
  { title: 'Config. de graduação', path: '/configuracoes/graduacao' },
  { title: 'Config. de treinos/turmas', path: '/configuracoes/treinos' },
  { title: 'Config. de tipos de treino', path: '/configuracoes/tipos-treino' }
];
